...
const configuration_repository_1 = require("../../domain/configuration-repository");
const mongo_configuration_repository_1 = require("../mongodb/repositories/mongo-configuration-repository");
const telegram_bot_wins_repository_1 = require("../telegram/repositories/telegram-bot-wins-repository");
...
exports.default = [
    ...
    { bind: bot_wins_repository_1.BotWinsRepository, to: telegram_bot_wins_repository_1.TelegramBotWinsRepository },
    ...
    { bind: configuration_repository_1.ConfigurationRepository, to: mongo_configuration_repository_1.MongoConfigurationRepository },
